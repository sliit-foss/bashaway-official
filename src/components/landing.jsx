      ...
      <div className="flex flex-col min-h-[50vh] justify-between items-center" style={{ paddingTop: logoPaddingTop }}>
        ...
        <div className="w-fit bg-logo-container backdrop-blur-md rounded-lg p-2 flex justify-center items-center flex-wrap z-40 transform scale-75">
          <a href="https://sliitfoss.org" target="_blank">
            <img src="/assets/club-logos/foss-logo.svg" className="w-14 h-14 sm:w-28 sm:h-28 mx-5" />
          </a>
          <a href="https://wif-web.web.app" target="_blank">
            <img src="/assets/club-logos/wif-logo.png" className="w-[3.6rem] h-[3.6rem] sm:w-[7.3rem] sm:h-[7.4rem] mx-5" />
          </a>
          <a href="https://community.mozilla.org/en/groups/mozilla-campus-club-of-sliit/" target="_blank">
            <img src="/assets/club-logos/mozilla-logo.png" className="w-12 h-12 sm:w-24 sm:h-24 mx-3 filter brightness-115" />
          </a>
          <a href="https://www.facebook.com/sliit.fcsc/" target="_blank">
            <img src="/assets/club-logos/fcsc-logo.png" className="w-16 h-16 sm:w-36 sm:h-36 mx-5 mr-3 filter brightness-125" />
          </a>
          <a href="https://www.facebook.com/csnesc/" target="_blank">
            <img src="/assets/club-logos/csne-logo.png" className="w-12 h-12 sm:w-36 sm:h-36 mx-5 mr-3 filter brightness-125" />
          </a>
          <a href="https://www.facebook.com/sliit.cscs/" target="_blank">
            <img src="/assets/club-logos/cs-logo.png" className="w-10 h-12 sm:w-20 sm:h-24 mx-5 mr-3 filter brightness-125" />
          </a>
        </div>
      </div>
