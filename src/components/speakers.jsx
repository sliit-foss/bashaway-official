            ...
            <div className="flex flex-wrap justify-center items-center">
                {
                    speakerList.map((speaker, index) => {
                        return <Speaker key={speaker.name} name={speaker.name} position={speaker.position} image={speaker.image} linkedin={speaker.linkedin} sessionLink={speaker.sessionLink} aos={index === 0 ? 'fade-right' : 'fade-left'} />
                    })
                }
            </div>
        </div>
