...
const Sponsors = () => {
    const Sponsor = ({ logo, classes, aos }) => {
        return (<div data-aos={aos}><div className={`relative w-32 h-32 md:w-44 md:h-44 p-3 bg-black outline outline-2 outline-nav-links-unselected ring-4 rounded-full flex justify-center cursor-pointer items-center transform hover:scale-105 hover:outline-primary transition duration-300 ${classes}`}>
